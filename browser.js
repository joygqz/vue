(function (global, factory) {
	...
	***************************************************************************** */
	...
	function elementToOpenTagSegments(el, state) {
	    ...
	    // class
	    // guard against prototype pollution (CVE-2024-6783)
	    var hasStaticClass = hasOwn(el, 'staticClass') && el.staticClass;
	    var hasClassBinding = hasOwn(el, 'classBinding') && el.classBinding;
	    if (hasStaticClass || hasClassBinding) {
	        segments.push.apply(segments, genClassSegments(el.staticClass, el.classBinding));
	    }
	    // style & v-show
	    var hasStaticStyle = hasOwn(el, 'staticStyle') && el.staticStyle;
	    var hasStyleBinding = hasOwn(el, 'styleBinding') && el.styleBinding;
